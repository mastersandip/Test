...
namespace trukkerUAE.Controllers
{
    public class PostOrderController : ServerBase
    {
        ...
        [HttpGet]
        public DataTable GetUserPostOrderLoadStatusDetails(string userid)
        {
            DataTable dtPostLoadOrders = new DataTable();
            String query1 = "SELECT * FROM load_order_enquiry_quotation where shipper_id = @userid and active_flag= 'Y' and status in ('-01','02') Order by load_inquiry_no desc ";
            //String query1 = "SELECT * FROM load_order_enquiry_quotation where shipper_id = @userid and active_flag= 'Y' and status  = '02' Order by load_inquiry_no desc ";
            DBConnection.Open();
        ...
        [HttpGet]
        public DataTable GetReasonForRejection()
        {
            DataTable dtPostLoadOrders = new DataTable();
            String query1 = "SELECT reason_code,reason_desc FROM reason_master where active_flag= 'Y' ";
            //String query1 = "SELECT * FROM load_order_enquiry_quotation where shipper_id = @userid and active_flag= 'Y' and status  = '02' Order by load_inquiry_no desc ";
            DBConnection.Open();
            DBDataAdpterObject.SelectCommand.CommandText = query1;
            DataSet ds = new DataSet();
        ...
        [HttpGet]
        public DataTable GetUserPostOrderLoadStatusDetailsByinquiryId(string inquiryId, string ownerid)
        {
            DataTable dtPostLoadOrders = new DataTable();
            String query1 = "SELECT * FROM load_order_enquiry_quotation Where load_inquiry_no = @inqid and owner_id = @ownid and active_flag='Y' and status in ('-01','01','02') ";
            DBConnection.Open();
            DBDataAdpterObject.SelectCommand.Parameters.Clear();
            DBDataAdpterObject.SelectCommand.CommandText = query1;
            DBDataAdpterObject.SelectCommand.Parameters.Add(BLGeneralUtil.MakeParameter("inqid", DbType.String, inquiryId));
        ...
        [HttpGet]
        public DataTable GetQuoteByOwnerId(string loadinqid, string ownerid)
        {
            DataTable dtPostLoadOrders = new DataTable();
            String query1 = "SELECT * FROM load_order_enquiry_quotation where load_inquiry_no = @inqid and owner_id=@ownid and active_flag= 'Y'  ";
            DBConnection.Open();
            DBDataAdpterObject.SelectCommand.Parameters.Clear();
            DBDataAdpterObject.SelectCommand.CommandText = query1;
        ...
        [HttpGet]
        public DataTable GetPendingQuotationForShipper(string id)
        {
            // This method will bring all/selected quotation accepted by Transporter with suggested fixed cost.
            // status = 03 (Quote Accepted By Transporter. Awaiting Shipper Confirmation)
            DataTable dtPostLoadOrders = new DataTable(); String query1 = "";
            if (id != "")
                query1 = "SELECT * FROM load_order_enquiry_quotation where load_inquiry_no = @inqid and active_flag='Y' and status = '03' ";
            else
                query1 = "SELECT * FROM load_order_enquiry_quotation where active_flag='Y' and status = '03' ";
            DBConnection.Open();
            DBDataAdpterObject.SelectCommand.Parameters.Clear();
            DBDataAdpterObject.SelectCommand.CommandText = query1;
            DBDataAdpterObject.SelectCommand.Parameters.Add(BLGeneralUtil.MakeParameter("inqid", DbType.String, id));
        ...
        [HttpGet]
        public String GetQuotations(string id, string stat)
        {
            ...
            if (id != "-1" && stat == "-1")
                ...
                query1 = "SELECT * FROM load_order_enquiry_quotation where shipper_id = @inqid and active_flag= 'Y' ";
            else if (id == "-1" && stat != "-1")
                query1 = "SELECT * FROM load_order_enquiry_quotation where active_flag='Y' and status = @stats ";
            DBConnection.Open();
            DBDataAdpterObject.SelectCommand.Parameters.Clear();
            DBDataAdpterObject.SelectCommand.CommandText = query1;
            DBDataAdpterObject.SelectCommand.Parameters.Add(BLGeneralUtil.MakeParameter("inqid", DbType.String, id));
            DBDataAdpterObject.SelectCommand.Parameters.Add(BLGeneralUtil.MakeParameter("stats", DbType.String, stat));
            DataSet ds = new DataSet();
            DBDataAdpterObject.Fill(ds);
            if (ds != null && ds.Tables.Count > 0)
            {
        ...
        [HttpGet]
        public DataTable GetLoadInquiryfromTransporterNotification(string loadinqno)
        {
            DataTable dtPostLoadOrders = new DataTable();
            String query1 = "SELECT * FROM load_enquiry_transporter_notification  where load_inquiry_no = @inqid and active_flag=" + "'Y'";
            DBConnection.Open();
            DBDataAdpterObject.SelectCommand.Parameters.Clear();
            DBDataAdpterObject.SelectCommand.CommandText = query1;
        ...
        [HttpGet]
        public BLReturnObject GetDropDownDataforPostLoadEnquiry()
        {
            BLReturnObject objrtn = new BLReturnObject();
            DataTable dt_packtypes = new DataTable();
            DataTable dt_trucktypes = new DataTable();
            DataTable dt_mattypes = new DataTable();
            DataSet ds = new DataSet();

            String query1 = "SELECT * FROM pack_types ";
            String query2 = "SELECT * FROM material_types ";
            String query3 = "SELECT truck_body_id,truck_body_desc FROM truck_body_mst Where active_flag ='Y'";
            DBDataAdpterObject.SelectCommand.CommandText = query1;

            DBDataAdpterObject.TableMappings.Clear();
            DBDataAdpterObject.TableMappings.Add("Table", "dt_packtypes");
            DBDataAdpterObject.SelectCommand.CommandText = query1;
            DBDataAdpterObject.Fill(ds);

            DBDataAdpterObject.TableMappings.Clear();
            DBDataAdpterObject.TableMappings.Add("Table", "dt_mattypes");
            DBDataAdpterObject.SelectCommand.CommandText = query2;
            DBDataAdpterObject.Fill(ds);

            DBDataAdpterObject.TableMappings.Clear();
            DBDataAdpterObject.TableMappings.Add("Table", "dt_trucktypes");
            DBDataAdpterObject.SelectCommand.CommandText = query3;
            DBDataAdpterObject.Fill(ds);

            objrtn.dt_ReturnedTables = new DataTable[3];
            objrtn.dt_ReturnedTables[0] = ds.Tables[0];
            objrtn.dt_ReturnedTables[1] = ds.Tables[1];
            objrtn.dt_ReturnedTables[2] = ds.Tables[2];
            objrtn.ExecutionStatus = 1;
            objrtn.ServerMessage = "Success";
        ...
        public DateTime CalculateDeliveryDateTime(decimal aprx_kms, DateTime shipdate, TimeSpan shiptime)
        {
            int integral = 0; decimal fraction = 0;
            decimal hrs = 0; decimal mns = 0; int newhrs = 0; decimal exacthrs = 0;
            decimal totalhours = 0; int totalDays = 0; decimal remainhours = 0; decimal dayscalculated = 0;

            totalhours = aprx_kms / 30; // Considered 30 kms per hour 
            dayscalculated = (totalhours / 12); // Considered Driver works 12 hours a day.
            totalDays = (int)dayscalculated;

            remainhours = totalhours - (totalDays * 12);


            hrs = (int)decimal.Truncate(Math.Round(remainhours, 2));
            mns = Math.Round(((remainhours - hrs)) * 100, 0);
            ...
            exacthrs = hrs + mns;
            totalhours = BLGeneralUtil.GetRoundedValue(Constant.ROUNDING_UPTO_2_DECIMAL_PTS, exacthrs);
            integral = (int)decimal.Truncate(totalhours);

            if ((totalhours - integral) < 0.10M)
                fraction = ((totalhours - integral) * 100);
            else
                fraction = ((totalhours - integral) * 10);

            TimeSpan tm;
            tm = TimeSpan.Parse(integral.ToString("00") + ":" + fraction.ToString("00"));

            int shiphors = shiptime.Hours;
            int shipmins = shiptime.Minutes;

            int delhrs = tm.Hours;
            int delmns = tm.Minutes;

            if ((shipmins + delmns) > 59)
            {
                delhrs = shiphors + delhrs + 1;
                delmns = (shipmins + delmns) - 60;
            }
            else
            {
                delhrs = shiphors + delhrs;
                delmns = shipmins + delmns;
            }

            DateTime tt;
            tt = shipdate.AddDays(totalDays);
            if (delhrs > 23)
            {
                tt = tt.AddDays(1);
                if (delhrs == 24)
            ...
            tt = tt + TimeSpan.Parse(delhrs.ToString("00") + ":" + delmns.ToString("00") + ":00");
            return tt;
        }
        ...
        public string GetpostloadinquiryByID(string loadinqno)
        {
            ...
            //            String query1 = @" SELECT  res_inner.*,SizeTypeMatrix.Discount as  AddSerBaseDiscount,convert(char(5), load_inquiry_shipping_time, 108) [load_inquiry_shipping_time],*
            ...
            //                                left join(
            //	                                select * from(
            //                                            select load_inquiry_no,('Total_'+ServiceTypeCode+'_Charge')as ServiceTypeCode,ServiceCharge 
            //                                            from order_AddonService_details
            //                                        union
            //                                            select load_inquiry_no,('Total_'+ServiceTypeCode+'_Discount')as ServiceTypeCode,ServiceDiscount 
            //                                            from order_AddonService_details
            //                                    )res
            //                                    PIVOT(
            //                                        MAX(ServiceCharge) For ServiceTypeCode in (Total_PT_Charge,Total_PT_Discount,Total_CL_Charge,Total_CL_Discount,Total_PEST_Charge,Total_PEST_Discount)
            //                                    )pivot2
            ...
            if (dtPostLoadOrders != null && dtPostLoadOrders.Rows.Count > 0)
            {
                ...
                else
                {
                    ...
                    String query2 = @" SELECT  res_inner.*,SizeTypeMatrix.Discount as  AddSerBaseDiscount,convert(char(5), load_inquiry_shipping_time, 108) [load_inquiry_shipping_time],*
                                FROM post_load_inquiry
                                left join SizeTypeMatrix on post_load_inquiry.SizeTypeCode=SizeTypeMatrix.SizeTypeCode and SizeTypeMatrix.rate_type_flag=post_load_inquiry.rate_type_flag
                                left join(
	                                select * from(
            ...
            try
            {
                ...
                if (ds != null && ds.Tables.Count > 0)
                {
                    if (ds.Tables[0] != null && ds.Tables[0].Rows.Count > 0)
                    {
                        ...
                        if (dtPostLoadOrders != null)
                        {
                            dtPostLoadOrders.Columns.Add("TotalCount");
                            dtPostLoadOrders.Columns.Add("NewSrNo", typeof(int));
                            int rownumber = 1;
                            for (int i = 0; i < dtPostLoadOrders.Rows.Count; i++)
                            {
                                dtPostLoadOrders.Rows[i]["NewSrNo"] = rownumber;
                                dtPostLoadOrders.Rows[i]["TotalCount"] = dtrowcount;
                                rownumber++;
                            }
                        }

                        DataTable dtfinalorders = dtPostLoadOrders.Select("NewSrNo >= " + PageFrom + " AND  NewSrNo <=" + PageTo).CopyToDataTable();
